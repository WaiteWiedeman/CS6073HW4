...
# add pairs to list and convert to lowercase
...
# split pairs into training, validation, and test
...
plt.ylabel('CE/token')
plt.legend()
# decode function for analysis of test data
...
for test_pair in test_pairs[:30]:
    ...
    BLEUscore = nltk.translate.bleu_score.sentence_bleu([reference_sentence], translated_sentence)
